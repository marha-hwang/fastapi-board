...
def select_comment(comment_id:str)->models.Comment:
...
def insert_comment(comment:models.Comment)->bool:
...
def update_comment(comment:models.Comment)->bool:
...
def select_comment_list(post_id:str)->comment_schema.CommentListRes:
    if not os.path.exists(COMMENT_DATA_FILE) : return None
    ...
    comment_list:list[comment_schema.Comment] = []
    ...
    comment_res = comment_schema.CommentListRes(comments=comment_list)
    return comment_res

def select_comment_cnt(post_id:str)->int:
