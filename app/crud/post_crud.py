...
def select_post(post_id:str)->models.Post:
...
def insert_post(post:models.Post)->bool:
...
def update_post(post:models.Post)->bool:
...
def increase_view_post_cnt(post_id:str)->bool:
...
def select_post_all()->post_schema.PostListRes:
    ...
    for index, row in df.iterrows() :
        ...
        logger.info(str(post.__dict__))

        #배열에 추가
        post_list.append(post)
        
    post_res = post_schema.PostListRes(posts=post_list)
    return post_res
